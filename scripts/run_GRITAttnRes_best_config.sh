...
run_task () {
  ...
  "${PYTHON_BIN}" ${TRAIN_SCRIPT} \
    ...
    2>&1 | tee "${LOG_DIR}/${task}_AttnRes.log"
}
...
# batch_size uses conservative values to reduce OOM risk
#run_task diam   32  256   0.00082     0.00032    32    0.433
#run_task sssp   40  128   0.00048     0.00047    32    0.008
run_task charge 32  128  0.00034     0.00034    128    0.351
#run_task energy 12   64   0.00076     0.00094    128    0.178
#run_task energy 12   64   0.00038     0.00094    128    0.178
